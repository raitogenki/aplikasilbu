...
/* @var $model app\models\Form36Search */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form36-search">
    ...
    <?php // echo $form->field($model, 'kreditur_golongan') ?>

    <?php // echo $form->field($model, 'kreditur_hubungan_bank') ?>

    <?php // echo $form->field($model, 'kreditur_status') ?>
